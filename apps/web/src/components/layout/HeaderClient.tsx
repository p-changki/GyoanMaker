...
const AUTH_LINKS = [
  ...
  },
  {
    href: "/workbook",
    label: "워크북",
    icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5 5.189 5 3.139 5.835 1.5 7.137v11.606C3.139 17.44 5.189 16.605 7.5 16.605c1.746 0 3.332.477 4.5 1.253m0-11.605C13.168 5.477 14.754 5 16.5 5c2.311 0 4.361.835 6 2.137v11.606c-1.639-1.303-3.689-2.138-6-2.138-1.746 0-3.332.477-4.5 1.253",
  },
  {
