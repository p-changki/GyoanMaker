...
const FAQS = [
  ...
  },
  {
    ...
    a: "무료 플랜은 월 10회 속도 생성, 5회 정밀 생성, 5 삽화 크레딧, 최대 3개 교안 저장이 가능합니다. 베이직 이상 플랜은 무제한 저장을 지원합니다.",
  },
  {
    q: "삽화 크레딧은 무엇이며 어떻게 사용되나요?",
    a: "삽화 크레딧은 교안에 AI 삽화를 생성할 때 소비됩니다. 표준 품질 삽화는 1크레딧, 고품질 삽화는 2크레딧이 차감됩니다. 삽화 크레딧은 속도/정밀 할당량과 별도로 관리됩니다.",
  },
  {
    q: "스타일 테스트와 삽화 샘플은 무엇인가요?",
    a: "스타일 테스트는 삽화 컨셉을 교안에 적용하기 전에 미리 확인할 수 있는 기능입니다. 각 플랜별로 일일 스타일 테스트 횟수가 정해져 있습니다 (예: 무료 3회/일, 스탠다드 10회/일). 삽화 샘플은 저장하여 재사용할 수 있는 스타일로, 무료 플랜은 최대 10개, 스탠다드는 30개까지 저장 가능합니다.",
  },
  {
  ...
  },
  {
    ...
    a: "아닙니다. 실패한 생성은 할당량에서 차감되지 않습니다. 삽화는 성공한 건만 차감됩니다.",
  },
  {
