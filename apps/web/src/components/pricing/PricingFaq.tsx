...
const FAQS = [
  ...
  },
  {
    ...
    a: "월 정기 구독은 결제일로부터 1개월(30일) 이용 후 자동 갱신됩니다. 매월 동일한 날짜에 자동 결제되며, 갱신 전 해지하면 현재 기간 종료 시 자동으로 무료 플랜으로 전환됩니다. 크레딧(추가 이용권)은 결제일로부터 90일간 유효하며, 기간 만료 시 자동 소멸되고 갱신되지 않습니다.",
  },
  {
    q: "월간 사용량은 언제 초기화되나요?",
