        ...
        <div className="bg-white rounded-3xl shadow-premium border border-gray-200/60 p-8 space-y-6">
          <div className="text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {showCredentials ? "이메일과 비밀번호를 입력하세요" : "Google 계정으로 시작하세요"}
            </p>
          </div>
            ...
            <form onSubmit={handleCredentialsLogin} className="space-y-4">
              <div>
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-2xl border border-gray-200 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400"
                />
              </div>
              <div>
                <input
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3 rounded-2xl bg-blue-600 text-white font-semibold text-sm hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
