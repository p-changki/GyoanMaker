      ...
      <div className="space-y-8 text-gray-700 leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 mt-3 space-y-1">
            ...
            <li>
              <strong>무통장입금(계좌이체)</strong>을 통한 결제도 가능합니다.
              무통장입금 시 다음 사항이 적용됩니다:
              <ul className="list-disc pl-6 mt-1 space-y-1">
                <li>
                  주문일로부터 3영업일 이내 미입금 시 해당 주문은 자동
                  취소됩니다.
                </li>
                <li>
                  입금 확인 후 영업일 기준 1~2일 이내 서비스가 적용되며,
                  적용 완료 시 가입 이메일로 통지합니다.
                </li>
                <li>
                  주말·공휴일에는 입금 확인 및 서비스 적용이 지연될 수
                  있습니다.
                </li>
              </ul>
            </li>
            ...
            <li>
              <strong>워크북(문제지) 생성</strong>은 교안 생성과 동일하게 선택한
              모드(빠른 모드/정밀 모드)의 지문 사용량에서 차감됩니다.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>환불은 요청일로부터 영업일 기준 3~7일 이내에 처리됩니다.</li>
            <li>
              무통장입금으로 결제한 경우, 환불은 원래 입금 계좌로
              처리됩니다. 계좌 확인을 위해 환불 요청 시 입금 계좌 정보를
              함께 기재해주세요.
            </li>
            <li>
              현금 결제(무통장입금) 건당 10만원 이상 거래 시 현금영수증이
              발급되며, 사업자 거래의 경우 세금계산서 발행이 가능합니다.
            </li>
          </ul>
        </section>
