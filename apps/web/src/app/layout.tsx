...
export const metadata: Metadata = {
  ...
  description:
    "영어 지문을 입력하면 AI가 문장 분석·핵심 어휘·요약·워크북을 자동 생성합니다. 학원·과외·영어 교사를 위한 PDF 교안을 원클릭으로 제작하세요. 어휘 테스트·포켓보카 기능 포함.",
  keywords: [
    "영어 교안",
    "AI 교안 생성기",
    "영어 교안 만들기",
  ...
  openGraph: {
    ...
    description:
      "영어 지문 분석부터 교안 출력까지 한 번에. AI가 문장 분석·핵심 어휘·요약·워크북을 자동 생성합니다. 학원·과외·영어 교사 필수 도구.",
    url: SITE_URL,
    siteName: "교안메이커",
    locale: "ko_KR",
    type: "website",
