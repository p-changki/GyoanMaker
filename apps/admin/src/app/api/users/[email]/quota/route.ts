...
import { getQuotaStatus, setQuotaLimits } from "@gyoanmaker/server-lib/quota";

/**
 * GET /api/users/[email]/quota — Get user quota status
 */
...
/**
 * PATCH /api/users/[email]/quota — Update user quota limits
